...
class Solution {
	...
	/*
	 * START TEST CASES You can add test cases in the three functions below:
	 * employeesInputs(), friendshipsInputs(), and expectedOutputs(). Each test
	...
	public static List<List<String>> employeesInputs() {
		...
		inputs.add(Arrays.asList("1,Richard,Engineering", "2,Erlich,HR", "3,Monica,Business", "4,Dinesh,Engineering",
	...
	public static List<List<String>> friendshipsInputs() {
		...
		inputs.add(Arrays.asList("1,2", "1,3", "1,6", "2,4"));
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < employeesInputs.size(); i++) {
			try {
				Map<Integer, List<Integer>> result = createAdjacencyLists(employeesInputs.get(i),
						friendshipsInputs.get(i));
